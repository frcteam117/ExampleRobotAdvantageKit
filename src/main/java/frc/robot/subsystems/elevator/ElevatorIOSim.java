...
public class ElevatorIOSim implements ElevatorIO {
  ...
  public void updateInputs(ElevatorIOInputs ioInputs) {
    ...
    ioInputs.rotorAngle = ioInputs.mechanismHeight.timesConversionFactor(gearRatio);
    ioInputs.rotorVelocity = ioInputs.mechanismVelocity.timesConversionFactor(velocityGearRatio);
