...
public class ElevatorConstants {
  ...
  static {
    motorConfig
        ...
        .pidf(simP, simI, simD, 0.0, ClosedLoopSlot.kSlot0)
        .maxMotion
        // Set MAXMotion parameters for position control
        .maxVelocity(maxVelocity.in(MetersPerSecond))
        .maxAcceleration(maxAcceleration.in(MetersPerSecondPerSecond))
        .allowedClosedLoopError(0.0005)
        .positionMode(MAXMotionPositionMode.kMAXMotionTrapezoidal, ClosedLoopSlot.kSlot0);
    motorConfig.encoder.positionConversionFactor(1).velocityConversionFactor(1.0 / 60.0);
  }
}
